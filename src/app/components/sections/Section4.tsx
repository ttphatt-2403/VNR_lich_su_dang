    ...
    <MagazinePage id="phan-3" pageNum={27}>
        ...
        >
          ...
          <div style={{
            ...
            <p style={{
              ...
              <span style={{ fontWeight: 500, color: "rgba(252,249,242,0.9)", fontFamily: C.body, fontSize: 18.5, fontStyle: "normal", marginLeft: 4 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1px 1fr", gap: 0, marginBottom: 32 }}>
        ...
        <div style={{ paddingRight: 24 }}>
          <Reveal>
            ...
            <p style={{ fontFamily: C.body, fontSize: 18.5, fontStyle: "italic", color: C.brown, marginBottom: 16, marginTop: 0 }}>
      ...
      <Reveal>
        <div style={{ background: C.bg2, padding: "24px 28px", borderLeft: `4px solid ${C.red}`, borderRight: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`, borderTop: `1px solid ${C.border}` }}>
          <h4 style={{ fontFamily: C.serif, fontSize: 18, fontWeight: 700, color: C.red, margin: "0 0 12px 0", textTransform: "uppercase", letterSpacing: "0.05em" }}>Kết luận</h4>
          <p style={{ fontFamily: C.body, fontSize: 18, lineHeight: 1.7, color: C.dark, opacity: 0.9, margin: "0 0 14px 0" }}>
          ...
          <p style={{ fontFamily: C.body, fontSize: 18, lineHeight: 1.7, color: C.dark, opacity: 0.9, margin: 0 }}>
